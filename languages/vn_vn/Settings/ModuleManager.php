...
$languageStrings = array(
	...
	'LBL_ACCEPT_WITH_THE_DISCLAIMER' => 'Tôi chấp nhận và từ chối mọi lỗi phát sinh trong qua trình cài đặt của mình',
	...
	'LBL_IMPORT_MODULE_FROM_ZIP' => 'Cài đặt mới Module',
	'LBL_UPDATE_NOW' => 'Update Now',
	'LBL_IMPORT_NOW' => 'Import Now',
	'LBL_DISCLAIMER_FOR_IMPORT_FROM_ZIP' => '<b>* CẢNH BÁO! TRƯỚC KHI CÀI ĐẶT</b> <br>  
												 Chức năng này đã được cung cấp cho Nhà phát triển để thử nghiệm các Module mới.
													Nếu bạn đang cài đặt từ một tệp được cung cấp bởi bên thứ 3, vui lòng chỉ tiếp tục nếu bạn tin tưởng nhà xuất bản. Các mô-đun tùy chỉnh có thể bao gồm các lỗ hổng bảo mật và ghi đè lên các tệp hệ thống khiến CRM của bạn gặp rủi ro. Mô-đun bạn sắp cài đặt chưa được CRM xem xét.',
);
